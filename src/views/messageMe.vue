...
<!--                 <span class="inline-block mb-4 text-sm text-blue-500 font-bold uppercase tracking-widest">Message Me</span> -->
                ...
                <p class="text-gray-200 font-bold text-xl">
                  Shoot me a message about anything anonymously. If you have a current order, include your passphrase with your message. If your question is, "Is this service active?" The answer is yes.  I welcome all other questions you might have!
